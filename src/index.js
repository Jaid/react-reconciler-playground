/** @module react-reconciler-playground */
 ...
 * @example
 * import reactReconcilerPlayground from "react-reconciler-playground"
 * let result = reactReconcilerPlayground(["a", "b"])
 * result = {a: null, b: null}
 * @example
 * import reactReconcilerPlayground from "react-reconciler-playground"
 * let result = reactReconcilerPlayground(["a", "b"], "value")
 * result = {a: "value", b: "value"}
 * @example
 * import reactReconcilerPlayground from "react-reconciler-playground"
 * let result = reactReconcilerPlayground(["a", "b"], (key, index) => `value for ${key} #${index + 1}`)
 ...
 * import {parallel} from "react-reconciler-playground"
